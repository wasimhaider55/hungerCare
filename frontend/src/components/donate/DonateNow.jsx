        ...
        <main className=' pt-20'>
            ...
            <div className='w-full h-52 bg-cover bg-center bg-[url("https://image.khaleejtimes.com/?uuid=9d530cb1-b2d2-5933-b804-fabeb18997de&function=cropresize&type=preview&source=false&q=75&crop_w=0.99999&crop_h=0.85188&x=0&y=0&width=1200&height=675")]'>
                <div className='pt-20 md:pl-20 pl-10 '>
                    ...
                    <p className='text-2xl text-white pt-5'>Help feed hungry people today</p>
                </div>
            </div>
            ...
            <div className='w-full sm:h-72 h-80 bg-blue-500 my-10 text-center'>
                <div className='pt-10  px-4 '>
                    <h1 className='text-white text-4xl font-bold'> Have you surplus food to donate?</h1>
                    <p className=' text-white opacity-70 text-2xl font-bold pt-3'>If you are a business with surplus food, please find out what we can take</p>
                    <Link to="/DonateFood">
            ...
            <div className='w-full sm:h-72 h-80 bg-blue-500 my-10 text-center'>
                <div className='pt-10 pl-3 '>
                    <h1 className='text-white text-4xl font-bold'> Have you money to donate?</h1>
                    <p className=' text-white opacity-70 text-2xl font-bold pt-3 pr-3'>if you want to donate money please find out what we can take.</p>
                    <Link to="/DonateMoney">
                        <button className="bg-blue-600 text-white  px-6 py-2 rounded-full items-center mt-16 hover:bg-blue-900">
                            Donate Money
                        </button>
